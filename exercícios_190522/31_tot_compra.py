# 31) Uma empresa vende um produto a R$5,40 a unidade. Sabendo-se que existe um desconto acumulado de 0,5% do valor total da compra a cada centena comprada deste produto. Escreva um algoritmo que receba a quantidade comprada desse produto e informe.
...
produto_quantidade = int(input('Informe a quantidade comprada:'))
...
print(f'Total sem desconto: {total_sem_desconto}.')
print(f'Centenas compradas: {centenas_compradas}.')
print(f'Desconto: {desconto_total}.')
